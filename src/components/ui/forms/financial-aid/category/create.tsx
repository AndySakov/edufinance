...
export function CreateFinancialAidCategoryForm() {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    client
      .post<ResponseWithOptionalData<FinancialAidCategory>>(
        `/financial-aid-types`,
        {
          ...values,
        }
      ...
      .then((res) => {
        if (res.data.success) {
          ...
          console.log("Financial Aid Category created");
        } else {
          console.log("Error creating financial aid category");
          toast({
            title: "Error",
